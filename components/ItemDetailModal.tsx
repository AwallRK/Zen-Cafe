                            ...
                            <div className="p-10">
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    <div className="lg:col-span-2">
                                        <div className="mb-6">
                                            <h2 className="text-4xl font-bold text-[#333333] mb-3">{item.name}</h2>
                                            {item.origin && (
                                                <p className="text-[#465775] font-medium mb-2">Origin: {item.origin}</p>
                                            )}
                                        ...
                                        <p className="text-[#333333] opacity-90 leading-relaxed text-lg mb-8">
                                            {item.description}
                                        </p>
                                        {item.ingredients && (
                                            <div className="mb-8">
